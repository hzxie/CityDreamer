...
# @Last Modified at: 2023-06-07 20:01:05
...
cfg.NETWORK.GANCRAFT.LOCAL_ENCODER_ENABLED       = False
cfg.NETWORK.GANCRAFT.LOCAL_ENCODER_N_BLOCKS      = 6
cfg.NETWORK.GANCRAFT.POSITIONAL_EMBEDDING        = ""
cfg.NETWORK.GANCRAFT.HASH_GRID_N_LEVELS          = 16
cfg.NETWORK.GANCRAFT.HASH_GRID_LEVEL_DIM         = 8
cfg.NETWORK.GANCRAFT.SINE_COSINE_FREQ_BENDS      = 10
cfg.NETWORK.GANCRAFT.RENDER_USE_SIREN            = True
...
cfg.NETWORK.GANCRAFT.RENDER_OUT_DIM_COLOR        = 3
