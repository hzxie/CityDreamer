...
# @Last Modified at: 2023-05-30 10:55:37
...
cfg.NETWORK.GANCRAFT.HASH_GRID_N_BLOCKS          = 6
cfg.NETWORK.GANCRAFT.GRID_N_LEVELS               = 16
cfg.NETWORK.GANCRAFT.GRID_LEVEL_DIM              = 8
...
cfg.TRAIN.GANCRAFT.ENABLE_EMA                    = True
